...
dataset_dir = (
    "/kaggle/input/datasets/jakeclark38a/smart-contract-vulnerability-detection"
)
...
def train_and_evaluate(column_name, train_df, test_df, label_columns, output_dir):
    ...
    train_encodings = tokenizer(
        train_texts, truncation=True, padding=True, max_length=None, return_tensors="pt"
    )
    test_encodings = tokenizer(
        test_texts, truncation=True, padding=True, max_length=None, return_tensors="pt"
    )
    ...
    # Set train dataset to 80% and eval dataset to 20% of train_dataset

    # Split train_dataset into train and eval datasets
...
results_json = {
    "configuration": {"model": "distilbert-base-uncased", "labels": label_columns},
    "results": all_results,
